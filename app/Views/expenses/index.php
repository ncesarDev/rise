...
<style>
.w-20 {
  width: calc(100px + 0px); /* Ajusta el ancho según tus necesidades */
}
</style>
...
<?php } ?>
            ...
            {visible: false, searchable: false},
              {title: '<?php echo app_lang("date") ?>', "iDataSort": 0, "class": "all w-20"}, // Añadir la clase "w-20" para incrementar el ancho
