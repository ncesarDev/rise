...
//add cliente
$links .= modal_anchor(get_uri("clients/modal_form"), app_lang('add_client'), array("class" => "dropdown-item clearfix", "title" => app_lang('add_client'), "id" => "js-quick-add-client"));

//add servicio
$links .= modal_anchor(get_uri("projects/modal_form"), app_lang('add_project'), array("class" => "dropdown-item clearfix", "title" => app_lang('add_project'), "id" => "js-quick-add-project"));
