...
<div class="dashboards-row clearfix row">
    ...
    <div id="js-clock-in-out" class="card dashboard-icon-widget clock-in-out-card">
      <div class="card-body">
        ...
        <div class="widget-details">
          <!-- mod nicedev90 -->
          <h1> <?php echo isset($totalDisponible) ? count($totalDisponible)  : 0 ; ?> </h1>
    ...
    <a href="https://serlisa.com.pe/sistema/index.php/invoices/index" class="white-link">
      <div class="card  dashboard-icon-widget">
        <div class="card-body ">
          ...
          <div class="widget-details">
            <!-- mod nicedev90 -->
            <h1><?php echo isset($totalMantenimiento) ? count($totalMantenimiento) : 0 ; ?> </h1>
  ...
  <div class="widget-container col-md-3">
    <a href="https://serlisa.com.pe/sistema/index.php/events" class="white-link">
      <div class="card dashboard-icon-widget">
        <div class="card-body">
          ...
          <div class="widget-details">
            <h1> <?php echo count($totalDisponible) + count($totalMantenimiento) ; ?> </h1>
            <span class="bg-transparent-white"><strong>Total Equipos </strong></span>
          </div>
        </div>
      </div>
    </a>
  ...
  <div class="widget-container col-md-3">
    <a href="https://serlisa.com.pe/sistema/index.php/projects/all_tasks" class="white-link">
      <div class="card dashboard-icon-widget">
        <div class="card-body">
          <div class="widget-icon bg-info">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-list icon"><line x1="8" y1="6" x2="21" y2="6"></line><line x1="8" y1="12" x2="21" y2="12"></line><line x1="8" y1="18" x2="21" y2="18"></line><line x1="3" y1="6" x2="3.01" y2="6"></line><line x1="3" y1="12" x2="3.01" y2="12"></line><line x1="3" y1="18" x2="3.01" y2="18"></line></svg>
