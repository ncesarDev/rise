...
class Items_historial extends Security_Controller {
    ...
    function index() {
        return $this->template->rander("items_historial/index");
    }
    ...
    function modal_form() {
        ...
        return $this->template->view('items_historial/modal_form', $view_data);
    }
    ...
    function list_data() {
        ...
        $list_data = $this->Items_historial_model->get_details($options)->getResult();
        $result = array();
    ...
    private function _row_data($id) {
        $options = array("id" => $id);
        $data = $this->Items_historial_model->get_details($options)->getRow();
